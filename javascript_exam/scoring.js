...
$(document).ready(function () {
  ...
  function score_indicate() {
    ...
    console.log(sum);
     ...
     let average = sum / subject_points.length; //「平均点：」に各教科の平均点を出力する処理を記述する。
  ...
  function get_achievement() {
    ...
    if(averageIndicate >= 80) {// もし「averageIndicate」が80以上なら"A"を返します。
      ...
      return "C"   
    } else if(averageIndicate >= 0) {// もし「averageIndicate」がそれ以外なら"D"を返します。
      return "D"
    }           
  };
  ...
  function get_pass_or_failure() {
    ...
    // 入力xしたそれぞれの教科のうち、1つでも60点よりも低い点数があった場合、変数「judge」に"不合格"を再代入する処理を記述する。
  ...
  $('#btn-declaration').click(function () {
    ...
    $("#declaration").text(judgement());//ループするので、７０行目にbreak;追加したが止まらない
  });
});
...
//function removeLi() { 削除する押すと、項目２が消える
